...
const callback = "https://demo.epayservice.cn/650000/success"; //传给后台的回调地址
// const callback = 'https://120000.epayservice.cn/#/success'; //传给后台的回调地址

const region = '650000'; //区划号

const regular = /^65\d{18}$/; //非税缴款正则表达式

const regularText = '缴款码必须等于20位且65开头'; //非税缴款正则表达式提示信息
...
const api = {
  ...
  queryEinvoiceUrl: base + '/650000/queryEinvoiceUrl', //直接查电子票地址
