...
class NonTaxPay extends React.Component {
  ...
  render() {
    const { isPayCode, codeUrl, loadings, isModalVisible, type } = this.state;
    const layout = {
      labelCol: {
        span: 8,
      },
          ...
          <div className="onForm_pay">
            <div className="outForm_pay_qingdao">
              <div className="onForm_pay_top">
                <span>您当前位置: 统一公共支付 {'>>'} {type === '0' ? '非税缴款' : type === '1' ? '缴款查询' : '教育缴费'}</span>
              </div>
                  ...
                  <div className="middle_pay_right_org_e">
                    ...
                    >
                      <div className="classHover">
                        <span>{type === '0' ? '非税缴款' : type === '1' ? '缴款查询' : '教育缴费'}</span>
                      </div>
                    </div>
                    <Form
                      {...layout}
